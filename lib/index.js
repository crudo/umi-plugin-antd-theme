...
function _default(api) {
  ...
  var themeTemp = winPath((0, _path.join)(__dirname, "../../.plugin-theme"));

  if ((0, _fs.existsSync)(winPath((0, _path.join)(absNodeModulesPath, ".plugin-theme")))) {
    themeTemp = winPath((0, _path.join)(absNodeModulesPath, ".plugin-theme"));
  } // 增加中间件
